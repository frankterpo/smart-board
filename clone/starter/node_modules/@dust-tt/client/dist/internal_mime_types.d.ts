...
export declare const DATA_WAREHOUSE_MIME_TYPE: "application/vnd.dust.data-warehouse";
export declare const DATA_SOURCE_FOLDER_SPREADSHEET_MIME_TYPE: "application/vnd.dust.folder.spreadsheet";
export type DataSourceFolderSpreadsheetMimeType = typeof DATA_SOURCE_FOLDER_SPREADSHEET_MIME_TYPE;
...
export declare const CONTENT_NODE_MIME_TYPES: {
    GENERIC: {
        ...
        DATA_WAREHOUSE: "application/vnd.dust.data-warehouse";
    };
    FOLDER: {
        SPREADSHEET: "application/vnd.dust.folder.spreadsheet";
    };
    CONFLUENCE: {
        FOLDER: "application/vnd.dust.confluence.folder";
    ...
    SALESFORCE: {
        SYNCED_QUERY_FOLDER: "application/vnd.dust.salesforce.synced-query-folder";
    };
    GONG: {
...
export declare const INTERNAL_MIME_TYPES: {
    TOOL_INPUT: {
        TABLE: "application/vnd.dust.tool-input.table";
        DATA_SOURCE: "application/vnd.dust.tool-input.data-source";
        DATA_WAREHOUSE: "application/vnd.dust.tool-input.data-warehouse";
        AGENT: "application/vnd.dust.tool-input.agent";
        STRING: "application/vnd.dust.tool-input.string";
        NUMBER: "application/vnd.dust.tool-input.number";
        BOOLEAN: "application/vnd.dust.tool-input.boolean";
        ENUM: "application/vnd.dust.tool-input.enum";
        LIST: "application/vnd.dust.tool-input.list";
        REASONING_MODEL: "application/vnd.dust.tool-input.reasoning-model";
        DUST_APP: "application/vnd.dust.tool-input.dust-app";
        NULLABLE_TIME_FRAME: "application/vnd.dust.tool-input.nullable-time-frame";
        JSON_SCHEMA: "application/vnd.dust.tool-input.json-schema";
    };
    TOOL_OUTPUT: {
        BROWSE_RESULT: "application/vnd.dust.tool-output.browse-result";
        DATA_SOURCE_SEARCH_QUERY: "application/vnd.dust.tool-output.data-source-search-query";
        DATA_SOURCE_SEARCH_RESULT: "application/vnd.dust.tool-output.data-source-search-result";
        FILESYSTEM_PATH: "application/vnd.dust.tool-output.filesystem-path";
        DATA_SOURCE_NODE_LIST: "application/vnd.dust.tool-output.data-source-node-list";
        DATA_SOURCE_NODE_CONTENT: "application/vnd.dust.tool-output.data-source-node-content";
        DATA_SOURCE_INCLUDE_QUERY: "application/vnd.dust.tool-output.data-source-include-query";
        DATA_SOURCE_INCLUDE_RESULT: "application/vnd.dust.tool-output.data-source-include-result";
        EXTRACT_QUERY: "application/vnd.dust.tool-output.extract-query";
        EXTRACT_RESULT: "application/vnd.dust.tool-output.extract-result";
        FILE: "application/vnd.dust.tool-output.file";
        REASONING_SUCCESS: "application/vnd.dust.tool-output.reasoning-success";
        SQL_QUERY: "application/vnd.dust.tool-output.sql-query";
        EXECUTE_TABLES_QUERY_ERROR: "application/vnd.dust.tool-output.execute-tables-query-error";
        THINKING: "application/vnd.dust.tool-output.thinking";
        DATABASE_SCHEMA: "application/vnd.dust.tool-output.database-schema";
        QUERY_WRITING_INSTRUCTIONS: "application/vnd.dust.tool-output.query-writing-instructions";
        EXAMPLE_ROWS: "application/vnd.dust.tool-output.example-rows";
        TOOL_MARKER: "application/vnd.dust.tool-output.tool-marker";
        WEBSEARCH_QUERY: "application/vnd.dust.tool-output.websearch-query";
        WEBSEARCH_RESULT: "application/vnd.dust.tool-output.websearch-result";
        RUN_AGENT_RESULT: "application/vnd.dust.tool-output.run-agent-result";
        RUN_AGENT_QUERY: "application/vnd.dust.tool-output.run-agent-query";
        WARNING: "application/vnd.dust.tool-output.warning";
        AGENT_CREATION_RESULT: "application/vnd.dust.tool-output.agent-creation-result";
        TOOLSET_LIST_RESULT: "application/vnd.dust.tool-output.toolset-list-result";
        TOOLSET_DESCRIBE_RESULT: "application/vnd.dust.tool-output.toolset-describe-result";
        GET_DATABASE_SCHEMA_MARKER: "application/vnd.dust.tool-output.get-database-schema-marker";
        EXECUTE_TABLES_QUERY_MARKER: "application/vnd.dust.tool-output.execute-tables-query-marker";
    };
    GENERIC: {
        DATA_SOURCE: "application/vnd.dust.datasource";
        DATA_WAREHOUSE: "application/vnd.dust.data-warehouse";
...
export type DustMimeType = BigQueryMimeType | ConfluenceMimeType | GithubMimeType | GoogleDriveMimeType | IntercomMimeType | MicrosoftMimeType | NotionMimeType | SlackMimeType | SnowflakeMimeType | WebcrawlerMimeType | ZendeskMimeType | SalesforceMimeType | GongMimeType | DataSourceMimeType | DataWarehouseMimeType | DataSourceFolderSpreadsheetMimeType;
